...
const ContactUsBlock = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    // conditional logic for email js
    if (name && email && message) {
  ...
  return (
    <Box
      ...
      bg="brand.cambridgeBlue"
      py="3em"
      borderColor="brand.coolGray"
      gap="3em"
    >
      <Box w="40%">
      ...
      <Box w="40%">
        <FormControl mt="3em" isRequired>
          ...
          <FormLabel mt="1em">Message</FormLabel>
          <Textarea
          ...
          />
          <Box mt={6}>
            <Button background="brand.mintCream" onClick={handleFormSubmit}>
              Send Message
            </Button>
          </Box>
        </FormControl>
